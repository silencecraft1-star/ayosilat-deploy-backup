                                ...
                                <tbody id="tb-category">
                                    @foreach ($data as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->official }}</td>
                                            <td class="text-end">
                                                <a href="{{ url('admin/panels/kontigen/' . $item->id . '/peserta') }}"
                                                    ...
                                                    <form action="{{ route('admin.modifyKontigen') }}" method="POST">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="kontigen" class="form-control"
                                                                    id="kontigen" autocomplete="off" placeholder="Kontigen"
                                                                    value="{{$item->kontigen}}">
                                                            </div>
                                                            <div class="mb-3">
                                                            ...
                                                            <div class="mb-3">
                                                                ...
                                                                <input type="text" name="official" class="form-control"
                                                                    id="official" autocomplete="off" placeholder="Official"
                                                                    value="{{$item->official}}">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="nohp" class="form-label">No Hp</label>
                                                                <input type="text" name="nohp" class="form-control" id="nohp"
                                                                    autocomplete="off" placeholder="Nomor Hp"
                                                                    value="{{$item->hp}}">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="provinsi" class="form-label">Provinsi</label>
                                                                <input type="text" name="provinsi" class="form-control"
                                                                    id="provinsi" autocomplete="off" placeholder="Provinsi"
                                                                    value="{{$item->provinsi}}">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="kota" class="form-label">Kota</label>
                                                                <input type="text" name="kota" class="form-control" id="kota"
                                                                    autocomplete="off" placeholder="Nama Kota"
                                                                    value="{{$item->kota}}">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="kecamatan" class="form-label">Kecamatan</label>
                                                                <input type="text" name="kecamatan" class="form-control"
                                                                    id="kecamatan" autocomplete="off"
                                                                    placeholder="Nama Kecamatan" value="{{$item->kecamatan}}">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="desa" class="form-label">Desa</label>
                                                                <input type="text" name="desa" class="form-control" id="desa"
                                                                    autocomplete="off" placeholder="Nama Desa"
                                                                    value="{{$item->desa}}">
                                                            </div>
                                                            <div class="mb-3">
                                                                <label for="alamat" class="form-label">Alamat</label>
                                                                <input type="text" name="alamat" class="form-control"
                                                                    id="alamat" autocomplete="off" placeholder="Alamat"
                                                                    value="{{$item->alamat}}">
                                                            </div>
                                                        </div>
                ...
                <div class="modal-content">
                    ...
                    <form action="{{ route('admin.modifyKontigen') }}" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                <label for="kontigen" class="form-label">Kontigen</label>
                                <input type="text" name="kontigen" class="form-control" id="kontigen" autocomplete="off"
                                    placeholder="Kontigen">
                            </div>
                            <div class="mb-3">
                                <label for="manager" class="form-label">Manager</label>
                            ...
                            <div class="mb-3">
                                <label for="official" class="form-label">Official</label>
                                <input type="text" name="official" class="form-control" id="official" autocomplete="off"
                                    placeholder="Official">
                            </div>
                            <div class="mb-3">
                                <label for="nohp" class="form-label">No Hp</label>
                                <input type="text" name="nohp" class="form-control" id="nohp" autocomplete="off"
                            ...
                            <div class="mb-3">
                                <label for="kota" class="form-label">Kota</label>
                                <input type="text" name="kota" class="form-control" id="kota" autocomplete="off"
