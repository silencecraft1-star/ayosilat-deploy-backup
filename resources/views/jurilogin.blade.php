              ...
              >
                ...
                <div class="mb-3">
                  ...
                  <select name="role" class="form-control" id="">
                    ...
                    <option value="juri-ganda">Juri Seni Solo Creativ</option>
                    <option value="dewan-ganda">Dewan Seni Solo Creativ</option>
                    <option value="juri-tunggal">Juri Seni Tunggal</option>
                    <option value="dewan-tunggal">Dewan Seni Tunggal</option>
                    <option value="juri-regu">Juri Seni Regu</option>
                    <option value="dewan-tunggal">Dewan Seni Regu</option>
                  </select>
                </div>
                <div class="mb-2">
