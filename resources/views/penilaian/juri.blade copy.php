        ...
        <div class="mx-5 row ">
            <div class="col d-flex align-items-center justify-content-start">
                <div class="text">
                    ...
                    @endphp
                    <span class="team fw-bold text-uppercase">{{$kontigen->kontigen}}</span> <br>
                    <span class="peserta text-primary text-uppercase">{{$tim_birus->name}}</span>
                </div>
            </div>
            ...
            <div class="col d-flex align-items-center justify-content-end text-end">
                <div class="text">
                    @php
                     ...
                     @endphp
                    <span class="team fw-bold text-uppercase">{{$kontigen->kontigen}}</span> <br>
                    <span class="peserta text-danger text-uppercase">{{$tim_merahs->name}}</span>
                </div>
            </div>
        </div>
    </section>
    ...
    <section id="scorering" class=" mx-5 d-flex mb-3">
        ...
        <div class="blueScore table-responsive">
            <table class="table table-bordered border border-black">
                ...
                <tbody>
                    ...
                    @endphp
                    <tr>
                        <td colspan="3" class="d-flex flex-wrap" id="data1b">
                    ...
                    <tr>
                        <td colspan="3" class="d-flex flex-wrap" id="data2b">
                    ...
                    <tr>
                        <td colspan="3" class="d-flex flex-wrap" id="data3b">
            ...
            <div class="d-flex ">
                <div class="btn-wrap d-flex flex-column gap-2">
                    ...
                    <button
                        ...
                        class="btnSkill1 d-flex align-items-center justify-content-center btn btn-primary fs-5 py-4 px-5 px-lg-5 px-md-5 me-1 shadow border-black">
                ...
                <button
                    ...
                    class="btnSkill1 d-flex align-items-center justify-content-center btn btn-secondary fs-5 py-4 px-5 px-lg-5 px-md-5 me-1 shadow border-black">
        ...
        <div class="babak d-flex flex-column align-items-center">
            <table class="table tabelBabak">
                ...
                <tbody>
                    <tr>
                        <td class="text-center" @if ($babak == '1') style="background-color: #FFD600;" @endif>I</td>
                    </tr>
                    <tr>
                        <td class="text-center" @if ($babak == '2') style="background-color: #FFD600;" @endif>II</td>
                    </tr>
                    <tr>
                        <td class="text-center" @if ($babak == '3') style="background-color: #FFD600;" @endif>III</td>
                    </tr>
                </tbody>
            </table>
                                            ...
                                            <div class="row h100">
                                                ...
                                                <div class="col">
                                                    <button
                                                        ...
                                                        class="bt-notif btn btn-warning w-100 border-black shadow">
                                                        Invalid
                                                    </button>
                                                </div>
                                                <div class="col">
        ...
        <div class="redScore table-responsive">
            <table class="table table-bordered border border-black">
                ...
                <tbody>
                    ...
                    @endphp
                    <tr>
                        <td colspan="3" class="d-flex flex-wrap" id="data1m">
                            @forelse ($data1 as $item)
                                @if($item->isValid == "false")
                                    <div class="text-decoration-line-through">
                                        {{$item->score}},
                    ...
                    <tr>
                        <td colspan="3" class="d-flex flex-wrap" id="data2m">
                            @forelse ($data2 as $item)
                                @if($item->isValid == "false")
                                    <div class="text-decoration-line-through">
                                        {{$item->score}},
                    ...
                    <tr>
                        <td colspan="3" class="d-flex flex-wrap" id="data3m">
                            @forelse ($data3 as $item)
                                @if($item->isValid == "false")
                                    <div class="text-decoration-line-through">
                                        {{$item->score}},
            ...
            <div class="d-flex ">
                <button
                    ...
                    style="width: 100%;"
                    class="btnSkill2 d-flex align-items-center justify-content-center btn btn-secondary fs-5 py-4 px-0 px-lg-5 px-md-5 shadow border-black">
                    {{-- <img src="../assets/juri/images/kick.png" style="width: 20px;"> --}}
                    <span class="ms-1">Hapus Nilai Terakhir</span>
                </button>
                <div class="btn-wrap d-flex flex-column gap-2">
                    <button
                        ...
                        style="width: 100%;"
                        class="btnSkill2 d-flex align-items-center justify-content-center btn btn-danger fs-5 py-4 px-0 px-lg-5 px-md-5 ms-1 shadow border-black">
                        <img src="../assets/juri/images/fist.png" style="width: 40px;">
                        <span class="ms-1">Pukulan</span>
                    </button>
                    <button
